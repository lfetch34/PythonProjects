# Luke Fetchko
# I found two bugs one in the find method and one in the find_place method, it should say 'lng' instead of 'lat',
# it seems that it was retrieving the latitiude twice or calculating distances incorrectly with latitudes before my fix of changing the second 'lat' with 'lng' due to this.
...
class GeoLocator:
    ...
    def __get_xml(location):
        url_string = ("https://maps.googleapis.com/maps/api/geocode/xml?sensor=false&address=" +
                      ...
                      "&key=AIzaSyCuycBwE5sn1HtEQ079stB94xxdHdl2yJc")
        try:
